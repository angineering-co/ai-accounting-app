...
export function generateVoucherDemoData(
  ...
  documents.push({
    ...
    type: "VAT",
    doc_type: "invoice",
    file_url: "demo/invoices/2026-01-15-stationery.pdf",
    ocr_status: "done",
    amount: 3300,
    duplicate_of: null,
    status: "active",
    created_by: userId,
    created_at: at("2026-01-15T09:00:00Z"),
    updated_at: at("2026-01-15T09:00:00Z"),
  });
  ...
  documents.push({
    ...
    type: "VAT",
    doc_type: "invoice",
    file_url: "demo/invoices/2026-01-20-travel.pdf",
    ocr_status: "done",
    amount: 12600,
    duplicate_of: null,
    status: "active",
    created_by: userId,
    created_at: at("2026-01-20T09:00:00Z"),
    updated_at: at("2026-01-22T15:30:00Z"),
  });
  ...
  documents.push({
    ...
    type: "VAT",
    doc_type: "allowance",
    file_url: "demo/allowances/2026-02-05.pdf",
    ocr_status: "done",
    amount: 1050,
    duplicate_of: null,
    status: "active",
    created_by: userId,
    created_at: at("2026-02-05T10:00:00Z"),
    updated_at: at("2026-02-05T10:00:00Z"),
  });
  ...
  documents.push({
    ...
    type: "VAT",
    doc_type: "invoice",
    file_url: "demo/invoices/2026-02-10-sales.pdf",
    ocr_status: "done",
    amount: 21000,
    duplicate_of: null,
    status: "active",
    created_by: userId,
    created_at: at("2026-02-10T11:00:00Z"),
    updated_at: at("2026-02-10T11:00:00Z"),
  });
  ...
  documents.push({
    ...
    type: "VAT",
    doc_type: "invoice",
    file_url: "demo/invoices/2026-03-01-supplies.pdf",
    ocr_status: "done",
    amount: 5250,
    duplicate_of: null,
    status: "active",
    created_by: userId,
    created_at: at("2026-03-01T08:30:00Z"),
  ...
  documents.push({
    ...
    type: "VAT",
    doc_type: "invoice",
    file_url: "demo/invoices/2026-03-05-misc.pdf",
    ocr_status: "done",
    amount: 1050,
    duplicate_of: null,
    status: "active",
    created_by: userId,
    created_at: at("2026-03-05T14:00:00Z"),
    updated_at: at("2026-03-05T14:00:00Z"),
  });
  ...
  auditTrails.push({
    ...
    actor_id: userId,
    actor_at: at("2026-01-22T15:30:00Z"),
  });
  ...
  entries.push({
    ...
    client_id: clientId,
    document_id: doc3Id,
    voucher_no: "20260205-00001",
    voucher_type: "收入",
    entry_date: "2026-02-05",
    description: "誠品書店 進項折讓：1/15 文具用品退貨一批，折讓金額 1,050 元（含稅）",
    status: "posted",
    reverses_entry_id: null,
    posted_at: at("2026-02-06T09:00:00Z"),
    posted_by: userId,
    created_by: userId,
    created_at: at("2026-02-05T10:00:00Z"),
    updated_at: at("2026-02-06T09:00:00Z"),
  });
  lines.push(
  ...
  entries.push({
    ...
    client_id: clientId,
    document_id: doc4Id,
    voucher_no: "20260210-00001",
    voucher_type: "收入",
    entry_date: "2026-02-10",
    description: "ABC 顧問公司 軟體授權銷售：5 套年度方案，含 5% 營業稅共 21,000 元（已沖銷）",
    status: "reversed",
    reverses_entry_id: null,
    posted_at: at("2026-02-11T10:00:00Z"),
    posted_by: userId,
    created_by: userId,
    created_at: at("2026-02-10T11:00:00Z"),
    updated_at: at("2026-02-15T16:00:00Z"),
  });
  lines.push(
  ...
  entries.push({
    ...
    client_id: clientId,
    document_id: null,
    voucher_no: "20260215-00001",
    voucher_type: "轉帳",
    entry_date: "2026-02-15",
    description: "沖銷 20260210-00001：ABC 顧問公司 2/15 來函取消訂單，全額退款已執行",
    status: "posted",
    reverses_entry_id: entry4Id,
    posted_at: at("2026-02-15T16:00:00Z"),
    posted_by: userId,
    created_by: userId,
    created_at: at("2026-02-15T16:00:00Z"),
    updated_at: at("2026-02-15T16:00:00Z"),
  });
  lines.push(
  ...
  auditTrails.push({
    ...
    reason: "客戶取消訂單，全額沖銷",
    actor_id: userId,
    actor_at: at("2026-02-15T16:00:00Z"),
  });
  ...
  entries.push({
    ...
    client_id: clientId,
    document_id: null,
    voucher_no: "20260228-00001",
    voucher_type: "轉帳",
    entry_date: "2026-02-28",
    description: "二月份折舊（系統自動入帳）：辦公設備 + 電腦設備，依直線法分攤計提 5,000 元",
    status: "posted",
    reverses_entry_id: null,
    posted_at: at("2026-02-28T23:59:00Z"),
    posted_by: null,
    created_by: null,
    created_at: at("2026-02-28T23:59:00Z"),
  ...
  entries.push({
    ...
    posted_by: null,
    created_by: userId,
    created_at: at("2026-03-03T17:00:00Z"),
    updated_at: at("2026-03-03T17:00:00Z"),
  });
  lines.push(
